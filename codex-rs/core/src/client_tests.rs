...
#[test]
fn exact_kimi_compaction_clauses_preserve_256k_boundaries() {
    assert!(!kimi_dispatch::at_least_85_percent(262_144, 222_822));
    assert!(kimi_dispatch::at_least_85_percent(262_144, 222_823));
    assert!(!kimi_dispatch::under_50k_remaining(262_144, 212_144));
    assert!(kimi_dispatch::under_50k_remaining(262_144, 212_145));
}

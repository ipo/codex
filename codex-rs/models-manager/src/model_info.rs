...
const DEFAULT_PERSONALITY_HEADER: &str = "You are Codex, an AI coding agent. You and the user share the same workspace and collaborate to achieve the user's goals.";
